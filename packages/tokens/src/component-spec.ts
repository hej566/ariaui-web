export const componentSpec = {
  ...
  "description": "This README is the authoritative contract for the **tokens package**: architecture, naming conventions, CSS generation, and contribution workflows.",
  "parts": [],
  ...
  "learnedRequirements": {
    "learningSource": "../ariaui/packages/tokens/readme.md",
    "coverage": {
      "sourceSections": 73,
      "coveredSections": 73,
      "requirements": 464
    ...
    "sections": [
      ...
      {
        "title": "ShadcnDesign Variable Alignment",
        "sourceHeadingLevel": 2,
        "requirements": [
      ...
      {
        "title": "Auto-Generated vs Manual",
        "sourceHeadingLevel": 3,
        "requirements": [
      ...
      {
        "title": "1. **Simple color/layout tokens**",
      ...
      {
        "title": "2. **Composite tokens** (shadows, focus rings)",
        "sourceHeadingLevel": 4,
        "requirements": [
          "Edit `src/css.ts`:",
      ...
      {
        "title": "Unit tests (validate token structure)",
        "sourceHeadingLevel": 1,
        "requirements": [
      ...
      {
        "title": "Build TypeScript + generate CSS",
        "sourceHeadingLevel": 1,
        "requirements": [
      ...
      {
        "title": "2. Version packages (updates package.json + CHANGELOG.md)",
        "sourceHeadingLevel": 1,
        "requirements": [
      ...
      {
        "title": "Usage: Tailwind CSS Collection",
        "sourceHeadingLevel": 3,
        "requirements": [
      ...
      {
        "title": "Colors look wrong / white / black",
        "sourceHeadingLevel": 3,
        "requirements": [
      ...
      {
        "title": "Token overrides not applying",
        "sourceHeadingLevel": 3,
        "requirements": [
      ...
      {
        "title": "Missing @theme entry for new token",
        "sourceHeadingLevel": 3,
        "requirements": [
      ...
      {
        "title": "Build fails after editing tokens",
        "sourceHeadingLevel": 3,
        "requirements": [
          "**Common errors**:",
      ...
      {
        "title": "Performance: Too many CSS variables",
        "sourceHeadingLevel": 3,
        "requirements": [
      ...
      {
        "title": "Complete Primitive Scale List",
        "sourceHeadingLevel": 3,
        "requirements": [
